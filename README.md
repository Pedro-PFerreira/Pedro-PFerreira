...
| ---- | -------- | ------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------- |
| 5     | 1    | [Software Language Engineering](https://github.com/Pedro-PFerreira/ELS)   | Software Language Engineering project, which consisted of building a Domain-Specific Language (DSL), in three phases: an internal DSL, an external DSL, and the combination of both, for extracting and processing information from multiple type files (CSV, XML, JSON).|     19            |
...
| 4     | 2    | [DDJD (FEUPlings- The escape from corridor B)](https://pedro-pferreira.itch.io/feuplings-the-escape-from-corridor-b)   | FEUPLings is an addictive 2D puzzle game in which the user is tasked with helping the MEIC freshmen escape from FEUP's long corridor B. You'll face various obstacles, such as holes, walls and fire! However, the freshmen have various powers, as they can jump and change directions. Can you help them in time? |     15             |
