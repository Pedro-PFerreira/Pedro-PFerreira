...
| ---- | -------- | ------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------- |
| 5     | 1    | [Software Language Engineering](https://github.com/Fabio-A-Sa/Y5S1-EngenhariaLinguagensSoftware)   | Software Language Engineering project, which consisted of building a Domain-Specific Language (DSL), in three phases: an internal DSL, an external DSL, and the combination of both. It extracts and processes information from multiple type files (CSV, XML, JSON).|     19            |
